...
insert AccountType (TypeName) values (N'adminroster')
insert AccountType (TypeName) values (N'adminmcc')
...
insert into Account(UserName, DisplayName, Password, TypeID)
values ('staff', 'Nhân viên' ,'staff', 3)
go

insert into Account (UserName, DisplayName, Password, TypeID)
values ('adminmcc', 'Quản lý', 'adminmcc', 2)
go
...
delete from Danhsachnhom where ID = 6

--Tạo dữ liệu cho Nhân viên

insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email, Ngayhethanchungchi) values (1,N'B1',N'Nguyễn Hữu Nam','0988480945','nam.nguyenhuu@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email, Ngayhethanchungchi) values (1,N'B2',N'Đinh Hưng Đạo','0988611160','dao.dinh@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email, Ngayhethanchungchi) values (1,N'B2',N'Nguyễn Thái Hoàng','0902843948','hoang.nguyenthai@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email, Ngayhethanchungchi) values (1,N'A',N'Lê Trung Hưng','0908878083','hung.letrung@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (1,N'A',N'Nguyễn Thành Danh','0908981256','danh.nguyenthanh@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (1,N'Mech',N'Dương Thanh Sơn','01662552155','son.duongthanh@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (1,N'Mech',N'Nguyễn Khánh Toàn','0905221191','toan.nguyenkhanh@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (1,N'Mech',N'Nguyễn Thương Hải','0974895391','tuan.phanngoc@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (2,N'B1',N'Biên Công Tín','0985423245','duy.le@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (2,N'B1',N'Lê Đức Duy','0907936564','tin.biencong@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (2,N'A',N'Đỗ Quang Hưng','0909269699','hung.quangdo@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (2,N'A',N'Huỳnh Nguyễn Thái Hoà','0905922229','hoa.huynhnguyenthai@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (2,N'A',N'Nguyễn Văn Ngọc','01687774408','ngoc.nguyenvan@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (2,N'Mech',N'Dương Tuấn Hoàng','01214573852','hoang.duongtuan@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (2,N'Mech',N'Nguyễn Duy Minh','0987362964','minh.nguyenduy@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (2,N'Mech',N'Trần Tuấn Anh','0388648558','anh.trantuan@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (3,N'B2',N'Vũ Mạnh Cường','0936399049','cuong.manhvu@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (3,N'B1',N'Thái Nhật Phú','0974099626','phu.nhatthai@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (3,N'A',N'Nguyễn Văn Đăng','0988480945','dang.nguyen@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (3,N'A',N'Phan Tiến Tài','0988231640','tai.phantien@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (3,N'A',N'Trần Xuân Phong','0938212221','phong.tranxuan@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (3,N'A',N'Nguyễn Văn Khải','0983238461','khai.nguyenvan@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (3,N'Mech',N'Trần Đình Quân','0916295530','quan.trandinh@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (3,N'Mech',N'Lê Kim Quốc','01215755594','quoc.lekim@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (3,N'Mech',N'Đoàn Quốc Bảo','0929620489','bao.doanquoc@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (4,N'B2',N'Nguyễn Việt Trung','0944052882','trung.nguyenviet@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (4,N'B1',N'Lê Việt Hải','0937693877','hai.vietle@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (4,N'A',N'Đào Duy Thiện','0902644233','thien.daoduy@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (4,N'A',N'Bùi Hữu Đức','0938801480','duc.buihuu@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (4,N'A',N'Nguyễn Minh Trí','01268682946','tri.nguyenminh@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (4,N'Mech',N'Nguyễn Văn Thiên','0974341822','thien.nguyen@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (4,N'Mech',N'Nguyễn Hà Minh Hoàng','0902101005','hoang.nguyenhaminh@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (4,N'Mech',N'Trương Văn Thuận','01659121354','thuan.truongvan@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (4,N'Mech',N'Nguyễn Văn Tiến','0987437473','tien.nguyenvan@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (5,N'DMMB',N'Nguyễn Công Phượng','0907840641','phuoc.nguyen@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (5,N'DMMB',N'Nguyễn Minh Đức','0909608286','duc1.nguyenminh@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (5,N'DMMB',N'Huỳnh Tiến Đăng','0903701085','dang.huynh@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (5,N'A2',N'Nguyễn Raman Minh Huy','0909336856','huy.nguyenramanminh@jetstarpacific.com.vn',N'20201220')
insert dbo.Danhsachnhanvien (NhomID,ChungChi,Name,Phone,Email,Ngayhethanchungchi) values (5,N'A2',N'Võ Minh Phúc Tài','0374226709','tai.vominhphuc@jetstarpacific.com.vn',N'20201220')
